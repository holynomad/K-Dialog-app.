...
begin
   ...
   //
   ShowMessage('FTP 업로드/다운로드 기능 제공을 빠른 시간내 준비해서 오픈할게요 :-)');
...
//    - 2013.08.30 LSH
//    - 소스출처 : Google
//    - XE7 전환시 ipAddressStr 타입 String -> AnsiString 전환
//------------------------------------------------------------------------------
...
begin
   ...
   client.sin_addr.s_addr  := inet_addr(PAnsiChar(ipAddressStr));       // the inet_addr function converts a string containing an IPv4 dotted-decimal address into a proper address for the IN_ADDR structure. --> XE7 마이그레이션시 PChar -> PAnsiChar 전환
